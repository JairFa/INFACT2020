...
<body>
    ...
    <div>
		 <a id="factura" href="factura.php" class="btn btn-primary btn-lg"><b>Factura</b></a>
		 </div>
		 <div>
		 <a id="producto" href="producto.php" class="btn btn-primary btn-lg"><b>Producto</b></a>
		 </div>

		 <a id="inventario" href="inventario.php" class="btn btn-primary btn-lg"><b>Inventario</b></a>
	</div>
